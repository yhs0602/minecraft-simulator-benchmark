...
from experiments.tensor_optimized.async_video_recorder import AsyncTensorVideoRecorder


# copied from stable_baselines3/common/vec_env/vec_video_recorder.py
class AsyncTensorVecVideoRecorder(VecEnvWrapper):
    """
    ...
    video_recorder: AsyncTensorVideoRecorder  # Fixed type hint (PyLance)
